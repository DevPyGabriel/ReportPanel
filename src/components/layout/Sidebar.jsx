...
export const Sidebar = () => {
  return (
    <aside className="h-screen bg-white w-80 p-6 small-shadow">
      <div className="w-full flex flex-col gap-y-2">
        ...
        <a href='/reportAnalytics' className='w-full flex items-center p-3 gap-x-1 bg-green-100/70 rounded-md text-green-600 hover:bg-green-200/70 hover:text-green-700 transition-all duration-200 hidden'>
          <Icon.ReportAnalisis />
